    ...
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4 bg-secondary">
        <a
          ...
          class="list-group-item py-2 ripple text-white"
          aria-current="true"
          @class([Route::is('dashboard')])aria-current="page" href="{{route('dashboard')}}">patients
        
        <i class="bi bi-clipboard2-pulse-fill"></i><span></span>
        </a>
        <a class="list-group-item py-2 ripple text-white" @class([Route::is('staffDashboard')])aria-current="page" href="{{route('staffDashboard')}}">staff
